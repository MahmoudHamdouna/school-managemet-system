...
class MarkSheetController extends Controller
{
    ...
    public function MarkSheetGet(request $request){
        ...
        ->where('exam_type_id',$exam_type_id)->where('id_no',$id_no)->where('marks','<','30')->get()->count();
        // dd($count_fail);
        ...
        if($singleStudent == true) {
            ...
            return view('backend.report.marksheet.marksheet_pdf',compact('allMarks','allGrade','count_fail'));
        }else {
            $notification = array(
