...
class StudentFeeController extends Controller
{
    public function StudentFeeView(){
    	...
    	return view('backend.account.student_fee_view',$data);
    }
    ...
    public function StudentFeeAdd(){
    	...
    	return view('backend.account.student_fee_add',$data);
...
$registrationfee = FeeCategoryAmount::where('fee_categor_id',$fee_category_id)->where('class_id',$std->class_id)->first();
