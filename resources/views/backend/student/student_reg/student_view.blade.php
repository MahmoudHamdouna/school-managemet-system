 ...
 <input type="submit" class="btn btn-rounded btn-dark mb-5" name="search" value="Search">
	...
	@if(!'@search')				
	 ...
	 <img src="{{ (!empty($value['student']['image']))? url('upload/student_images/'.$value['student']['image']):url('upload/no_image.jpg') }}" style="width: 60px; width: 60px;"> 
                ...
                <td>
					<a title="Edit" href="{{ route('student.registration.promotion',$value->student_id) }}" class="btn btn-info" ><i class="fa fa-edit"></i></a>
                    <a title="Promotion" href="{{ route('student.registration.edit',$value->student_id) }}" class="btn btn-primary"><i class="fa fa-check"></i></a>
