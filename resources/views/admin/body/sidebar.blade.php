      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        @if (Auth::user()->role == 'Admin')
          ...
          <ul class="treeview-menu">
            <li class="{{ ($route == 'users.view')?'active':'' }}">
              <a href="{{ route('users.view') }}"><i class="ti-more"></i>View User</a>
            </li>
          ...
          <ul class="treeview-menu">
            ...
            <li class="{{ ($route == 'password.view')?'active':'' }}">
              <a href="{{ route('password.view') }}"
                ><i class="ti-more"></i>Change Password</a
              >
            </li>
          ...
          <li class="treeview {{ ($prefix == '/accounts')?'active':'' }}">
            ...
            <ul class="treeview-menu">
              ...
              <li class="{{ ($route == 'account.salary.view')?'active':'' }}">
                <a href="{{ route('account.salary.view') }}"><i class="ti-more"></i>Empolyee Salary</a>
              </li>
        ...
        <li class="treeview {{ ($prefix == '/reports')?'active':'' }}">
          ...
          <ul class="treeview-menu">
            <li class="{{ ($route == 'monthley.profit.view')?'active':'' }}">
              <a href="{{ route('monthley.profit.view') }}"><i class="ti-more"></i>Monthle-Yearly Profit</a>
            </li>
            ...
            <li class="{{ ($route == 'attendance.report.view')?'active':'' }}">
              <a href="{{ route('attendance.report.view') }}"><i class="ti-more"></i>Attendance Generate</a>
            </li>
